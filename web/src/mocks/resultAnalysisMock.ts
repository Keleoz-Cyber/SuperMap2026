  ...
  findings: [
    {
      ...
      title: '哪个深度层高值最多',
      statement: '第 3 层（20～30m），这一层的高值比例最高，为 33.3%',
    ...
    },
    {
      ...
      title: '最大的连续高值区',
      statement: 'A 区覆盖约 500.0，是当前最大的连续区域',
    ...
    },
    {
      ...
      title: '哪些区域延伸到模型边缘',
      statement: 'B、C 区延伸到模型边缘，实际范围可能比图上更大',
    ...
    },
    {
      ...
      kind: 'formal_model',
      title: '当前使用 Ordinary Kriging',
      statement: '共同参与比较的点有 50 个，RMSE 5.2，R² 0.92',
  ...
  findings: [
    {
      ...
      kind: 'largest_high_component',
      title: '最大的连续高值区',
      statement: 'A 区覆盖约 375.0，是当前最大的连续区域',
    ...
    },
    {
      ...
      kind: 'formal_model',
      title: '当前使用 IDW',
      statement: '共同参与比较的点有 45 个，RMSE 4.1，R² 0.88',
