...
export async function installMockApi(page: Page): Promise<void> {
  ...
  const RESULT_ANALYSIS_E2E = {
    ...
    domain_interpretation: {
      ...
      status: 'exploratory',
      overview: '共找到 3 个值得复核的区域。先看低阻区 低-A：位于 -760～-650，模型中覆盖约 900，最低值 10，没有碰到模型边缘。',
      cards: [
        {
          id: 'domain-low-1000001', component_id: 1000001, direction: 'low',
          title: '低阻异常区 低-A',
          summary: '位于 -760～-650，模型中覆盖约 900，最低值 10，没有碰到模型边缘',
        ...
        },
        {
          ...
          title: '高阻异常区 A',
          summary: '位于 -650～-550，模型中覆盖约 1200，最高值 58，没有碰到模型边缘',
          ...
          confidence: 'exploratory',
          limitations: ['高阻不能单独证明岩体完整、干燥或属于某种岩性'],
          spatial_target: { kind: 'component', component_id: 1, depth_bin_index: null },
        },
      ],
      global_limitations: [
        '高低值按当前模型的 p25/p75 划分，还需要现场资料复核',
        '电阻率高低可能由多种因素造成，需要结合地质、水文和钻孔资料',
      ],
    },
    model_evidence: {
      algorithm: 'idw',
    ...
    findings: [
      {
        ...
        title: '哪个深度层高值最多',
        statement: '第 2 层（-650～-500m），这一层的高值比例最高，为 45.1%',
      ...
      },
      {
        ...
        title: '最大的连续高值区',
        statement: 'A 区覆盖约 1200，是当前最大的连续区域',
      ...
      },
      {
        ...
        title: '哪些区域延伸到模型边缘',
        statement: 'B 区延伸到模型边缘，实际范围可能比图上更大',
      ...
      },
      {
        ...
        kind: 'formal_model',
        title: '当前使用 IDW',
        statement: '共同参与比较的点有 96 个，RMSE 1.2，R² 0.94',
      ...
      },
      {
        ...
        confidence: 'high',
        limitations: ['当前无法查看模型在不同位置的稳定程度'],
        spatial_target: null,
      },
    ],
    provenance: {
