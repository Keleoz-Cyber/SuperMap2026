...
评测组使用 Windows x64 免安装包：下载 `GeoModelingPlatform-1.0.0-win-x64.zip`，完整解压后双击 `启动平台.cmd`。包内已包含 Python 运行时、前端、SuperMap3D SDK、SQLite 和三个内置案例，无需安装 Python、Node.js、Docker 或 iServer。
